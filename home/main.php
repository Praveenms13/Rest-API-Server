                        ...
                        <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Folders</a>
                    ...
                    <div id="notesnavbar" style="display: none;">
                        <ul class="nav nav-pills p-3 bg-white mb-3 rounded-pill align-items-center">
                            ...
                            <li class="nav-item">
                                <a href="javascript:void(0)"
                                    class="nav-link rounded-pill note-link d-flex align-items-center px-2 px-md-3 mr-0 mr-md-2"
                                    id="note-social"> <i class="icon-share-alt mr-1"></i><span
                                ...
                                <div class="card-body p-0">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-lg-6 align-self-stretch bg-img-cover d-none d-lg-flex">
                                            <img src="https://clickup.com/blog/wp-content/uploads/2020/01/note-taking.png"
                                                width="100%" alt="">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="note-full-container" class="note-has-grid row">
                                <div class="col-md-4 single-note-item all-category" style="">
                                    <div class="card card-body">
                                        ...
                                        <h5 class="note-title text-truncate w-75 mb-0"
                                            data-noteheading="Book a Ticket for Movie">Add new Note<i
                                ...
                                <div class="col-md-4 single-note-item all-category note-social" style="">
                                    <div class="card card-body">
                                        <span class="side-stick"></span>
                                        <h5 class="note-title text-truncate w-75 mb-0"
                                            data-noteheading="Nightout with friends">Nightout
                                ...
                                <div class="col-md-4 single-note-item all-category note-important" style="">
                                    <div class="card card-body">
                                        <span class="side-stick"></span>
                                        <h5 class="note-title text-truncate w-75 mb-0"
                                            data-noteheading="Launch new template">Launch new
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 mb-3">
                                                            <div class="note-title">
                                                                ...
                                                                <input type="text" id="note-has-title"
                                                                    class="form-control" minlength="25"
                                                                    placeholder="Title" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
